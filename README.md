...
Alexandria is currently licensed under the GNU Affero General Public license, version 3.0.
...
If you'd like to contribute, please look at the [Contribution Guidelines](https://github.com/alexandria-oss/alexandria/blob/master/CONTRIBUTING.md).
...
If you want to donate, feel free to make the donation to our [PayPal account](https://github.com/alexandria-oss/alexandria).
